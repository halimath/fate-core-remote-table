...
export function modal(opts: ModalOptions): Modal {
    ...
    backdrop.classList.add("fixed", "inset-0", "bg-gray-500", "bg-opacity-75", "z-40", "backdrop-filter", "backdrop-blur-sm")

    const modalElement = document.createElement("div")
    modalElement.classList.add("fixed", "z-50", "inset-0", "overflow-y-auto")
