...
public record Response(String id, String self, Type type, Table table, Error error) {
    ...
    public static Response error(@NonNull final String self, final int code,
            @NonNull final String reason) {
        return new Response(UUID.randomUUID().toString(), self, Type.ERROR, null, new Error(code, reason));
    }

    public static Response table(@NonNull final String self,
    ...
    public record Error(int code, String reason) {
    }
