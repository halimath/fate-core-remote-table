...
type Aspect struct {
	// Embedded struct due to allOf(#/components/schemas/CreateAspect)
	CreateAspect `yaml:",inline"`
...
type Character struct {
	// Embedded struct due to allOf(#/components/schemas/CreateCharacter)
	CreateCharacter `yaml:",inline"`
	// Embedded fields due to inline allOf schema
	...
	// UUID of the characters's owner
...
type Session struct {
	// Embedded struct due to allOf(#/components/schemas/CreateSession)
	CreateSession `yaml:",inline"`
	// Embedded fields due to inline allOf schema
	Aspects    []Aspect    `json:"aspects"`
